...
public:
    ...
    std::pair<bool, T> lower_bound_aux(Node* root, T const& e) const;
...
template<typename T, typename ComparatorFunction>
inline std::pair<bool, T> SetTree<T, ComparatorFunction>::lower_bound(T const& e) const
{
   

    return lower_bound_aux(this->root_node, e);
}

template<typename T, typename ComparatorFunction>
inline std::pair<bool, T> SetTree<T, ComparatorFunction>::lower_bound_aux(Node * root, T const& e) const
{
